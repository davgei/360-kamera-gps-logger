...
log ""
log "VIKTIG — sett opp rclone (Google Drive) FØR omstart, ellers klarer ikke"
log "360logger-process å laste opp (den prosesserer, men opplasting feiler til det er satt opp):"
log "  rclone config      # lag en remote som heter 'gdrive' (Google Drive)"
log "  rclone lsd gdrive:  # test"
...
log "  journalctl -u 360logger-process.service -b -f"
